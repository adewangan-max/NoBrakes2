...
export const metadata: Metadata = {
  ...
  verification: {
    google: "lNwzVMWDpWALeZGGcXDBlnyQYFtQP72uppJz6DsivKg",
  },
};
    ...
    <html lang="en" className="dark">
      <body
        className={cn(
          quantico.className,
          geistMono.variable,
          "min-h-screen bg-[#030712] text-slate-200 antialiased selection:bg-indigo-500/30 selection:text-indigo-200"
        )}
      >
            ...
            <div className="container mx-auto px-4 py-12">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="col-span-1 md:col-span-2">
                  <h2 className="text-xl font-bold text-white mb-4">NoBrakes</h2>
